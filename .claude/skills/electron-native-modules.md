...
|-----|---------|----------|
| **127** | **Node.js 22.x** | CLI tools, scripts, Vitest |
| **140** | **Electron 39** | GUI apps |
| 137 | Node.js 24.x | Future CLI |
| 141 | Node.js 25.x | Bleeding edge |

**Key insight**: Node and Electron **never share ABIs**. Electron 39 bundles Node 22 internally but has ABI 140, not 127.
